    ...
    <div className="absolute left-1/2 top-[-42.375rem] aspect-square w-[78rem] -translate-x-1/2 rounded-full border border-n-2/5 md:top-[-38.5rem] xl:top-[-32rem]">
      ...
      <MouseParallax strength={0.07} parallaxContainerRef={parallaxRef}>
        <div className="absolute bottom-1/2 left-1/2 h-1/2 w-0.25 origin-bottom rotate-[46deg]">
          <div
            className={`-ml-1 -mt-36 size-2 rounded-full bg-gradient-to-b from-[#5EF0C6] to-[#0D1427] transition-transform duration-500 ease-out ${
        ...
        <div className="absolute bottom-1/2 left-1/2 h-1/2 w-0.25 origin-bottom rotate-[-56deg]">
          <div
            className={`-ml-1 -mt-32 size-4 rounded-full bg-gradient-to-b from-[#7BD1FF] to-[#0D1427] transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
        ...
        <div className="absolute bottom-1/2 left-1/2 h-1/2 w-0.25 origin-bottom rotate-[54deg]">
          <div
            className={`-ml-1 mt-[12.9rem] hidden size-4 rounded-full bg-gradient-to-b from-[#E57BFF] to-[#0D1427] transition-transform duration-500 ease-out xl:block ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
        ...
        <div className="absolute bottom-1/2 left-1/2 h-1/2 w-0.25 origin-bottom rotate-[-65deg]">
          <div
            className={`-ml-1.5 mt-52 size-3 rounded-full bg-gradient-to-b from-[#F3C565] to-[#0D1427] transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
        ...
        <div className="absolute bottom-1/2 left-1/2 h-1/2 w-0.25 origin-bottom rotate-[-85deg]">
          <div
            className={`-ml-3 -mt-3 size-6 rounded-full bg-gradient-to-b from-[#7BD1FF] to-[#0D1427] transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
        ...
        <div className="absolute bottom-1/2 left-1/2 h-1/2 w-0.25 origin-bottom rotate-[70deg]">
          <div
            className={`-ml-3 -mt-3 size-6 rounded-full bg-gradient-to-b from-[#5EF0C6] to-[#0D1427] transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
