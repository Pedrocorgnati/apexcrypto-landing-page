      ...
      {pricing.map((item) => (
        ...
        >
          ...
          <div className="mb-6 flex h-[5.5rem] items-center">
            {item.price !== undefined && (
              <>
                ...
                <span className="body-2 ml-2 text-n-3">/month</span>
              </>
            )}
          </div>
          ...
          <Button
            ...
            href={item.price !== undefined ? "/pricing" : "mailto:oi@apexcrypto.com"}
          >
            {item.price !== undefined ? "Upgrade now" : "Talk with the team"}
          </Button>
